...
from bridgeagent.tui.widgets.market_ticker import MarketTicker
from bridgeagent.tui.widgets.liquidation_stats import LiquidationStatsPanel
from bridgeagent.tui.widgets.positions_panel import PositionsPanel
...
class AIPanel(Static):
    ...
    def update_ai(self, state: AgentState):
        ...
        if not config.AWS_ACCESS_KEY_ID:
            ...
            output.append("`bridgeagent setup`", style="bold yellow")
